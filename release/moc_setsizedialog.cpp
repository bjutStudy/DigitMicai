/****************************************************************************
** Meta object code from reading C++ file 'setsizedialog.h'
**
** Created: Tue Oct 31 15:49:22 2017
...
#error "The header file 'setsizedialog.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_setSizeDialog[] = {
    "setSizeDialog\0\0,,\0sendSize(int,int,int)\0"
...
const QMetaObject &setSizeDialog::getStaticMetaObject() { return staticMetaObject; }
...
int setSizeDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: sendSize((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
...
// SIGNAL 0
void setSizeDialog::sendSize(int _t1, int _t2, int _t3)
{
